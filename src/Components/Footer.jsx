            ...
            <div className="col-xxl-5 col-md-6">
              <div className="footer-widget">
                <div className="logo-footer">
                  <a href="index.html">
                    <img src="assets/images/LogoPropVichaar.png" alt />
                  </a>
                </div>
                <div className="footer-widget-contact">
                  <ul className="list-unstyled">
                    ...
                    <li>
                      ...
                      <div ><a href="tel:+1234567899"style={{color:'#f75d15'}}>(+01) 123 456 7890</a></div>
                    </li>
                    <li>
                      <div><i className="bi bi-envelope"style={{color:'#f75d15'}} /></div>
                      <div><a href="https://mannatstudio.com/cdn-cgi/l/email-protection#5d3538312d1d2e382f383334293829733e3230"><span className="__cf_email__" data-cfemail="432b262f3303302631262d2a3726376d202c2e"style={{color:'#f75d15'}}>[email&nbsp;protected]</span></a></div>
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <div className="tiny-footer">                    
        <div className="row align-items-center">
          <div className="col-md-6 mb-0">
            Copyright © <span id="yearText" /> <strong>lorem</strong> Lorem, ipsum dolor.
          </div>
