                ...
                <div className="align-items-center row form-inputs">
                  ...
                  <div className="col-md-6 col-lg-5">
                    <div className="d-flex">
                      ...
                      <button
                        type="submit"
                        className="btn btn-secondary bordered"
                      >
                ...
                <div className="row">
                      ...
                      {/* <div className="footer-widget-contact">
                        <ul className="list-unstyled">
                          <li>
                            ...
                            <div>
                              Plot no. 288/3842(Sudha's), Nandan Vihar,Patia,
                          ...
                          <li>
                            ...
                            <div>
                              <a href="https://mannatstudio.com/cdn-cgi/l/email-protection#5d3538312d1d2e382f383334293829733e3230">
                                <span
                                  className="__cf_email__"
                                  data-cfemail="432b262f3303302631262d2a3726376d202c2e"
                                  style={{ color: "#f75d15" }}
                                >
                                  info@vichaarlab.com
                                </span>
                  ...
                  <div className="col-xxl-5 col-md-6 ms-auto">
                    <div className="footer-widget">
                      ...
                      {/* <div className="opening-hours my-5 ms-0">
                        <i
              ...
              <div className="col-xxl-5 col-lg-6 mr-top-footer">
                <div className="row">
                  <div className="col-md-6 col-12">
                    <div className="footer-widget">
                      <h4 className="widget-title text-dark">Adress</h4>
                      <p className="footer-text">
                        Plot no. 288/3842(Sudha's), Nandan Vihar, Patia,
                        Bhubaneswar, Odisha-751024.
                      </p>
                  ...
                  <li><a href="javascript:">Prop Vichaar 360</a></li>
                      ...
                      <div className="opening-hours my-5 ms-0">
                        <div className="text">
                          <span
                            className="fs-6 text-mute text-secondary d-block"
                  ...
                  <div className="col-md-4 col-12">
                    <div className="footer-widget">
                      <h4 className="widget-title text-dark">Get intouch</h4>
                      <div>
                        <a href="tel:+1234567899" style={{ color: "#f75d15" }}>
                          (+91) 9090972227
                        </a>
                      </div>
                      <div >
                      ...
                      {/* <div className="opening-hours mt-5 ms-0">
                        <div className="text">
                          <span
                            className="fs-6 text-mute text-secondary d-block"
                            style={{ letterSpacing: "1px" }}
            ...
            <div className="tiny-footer">
              <div className="row align-items-center">
                <div className="col-md-6 mb-0">
                  Copyright © <span id="yearText" />{" "}
                  <strong>2025 Vichaarlab</strong> .
                </div>
