...
const Navbar = () => {
  ...
  const isCustomStyle =
    ...
    location.pathname === "/PropVicCRM" ||
    location.pathname === "/PropVicBMS" ||
    location.pathname === "/Services" ||
    location.pathname === "/PropVicEnterprize" ||
    location.pathname === "/PropVic360" ||
  ...
  const textColor = isMobileView
    ? { color: "#000" } // Set text color to black in mobile view
    : isScrolled
