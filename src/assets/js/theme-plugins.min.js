...
!(function ($) {
  "use strict";
  ($.fn.appear = function (b, a) {
    var c = $.extend({ data: void 0, one: !0, accX: 0, accY: 0 }, a);
    return this.each(function () {
      var a = $(this);
      if (((a.appeared = !1), !b)) {
        a.trigger("appear", c.data);
        return;
      }
      var f = $(window),
        d = function () {
          ...
          var b = f.scrollLeft(),
            ...
            m = a.width(),
            n = f.width();
          h + k + j >= d && h <= d + l + j && g + m + i >= b && g <= b + n + i
            ? a.appeared || a.trigger("appear", c.data)
            : (a.appeared = !1);
        },
        e = function () {
          if (((a.appeared = !0), c.one)) {
            f.unbind("scroll", d);
            var e = $.inArray(d, $.fn.appear.checks);
            e >= 0 && $.fn.appear.checks.splice(e, 1);
          }
          b.apply(this, arguments);
        };
      c.one ? a.one("appear", c.data, e) : a.bind("appear", c.data, e),
        f.scroll(d),
        $.fn.appear.checks.push(d),
        d();
    });
  }),
    $.extend($.fn.appear, {
      ...
      timeout: null,
      checkAll: function () {
        var a = $.fn.appear.checks.length;
        if (a > 0) for (; a--; ) $.fn.appear.checks[a]();
      },
      run: function () {
        $.fn.appear.timeout && clearTimeout($.fn.appear.timeout),
    ...
    return (
      ...
      $(this).each(function () {
        var b = $.extend(
          ...
          e = Math.ceil(b.speed / b.refreshInterval),
          h = (b.to - b.from) / e,
          i = this,
          d = $(this),
          j = 0,
        ...
        d.data("countTo", c),
          ...
          (c.interval = setInterval(function () {
            (f += h),
              j++,
              g(f),
              "function" == typeof b.onUpdate && b.onUpdate.call(i, f),
              j >= e &&
                (d.removeData("countTo"),
                clearInterval(c.interval),
                (f = b.to),
                "function" == typeof b.onComplete && b.onComplete.call(i, f));
          }, b.refreshInterval)),
          g(f);
      })
    );
